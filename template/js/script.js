  ...
  $(function() {
                ...
                $this.googleMap({
                  ...
                  onInit: function(map) {
                    ...
                    if (inputAddress.length) {
                      ...
                      $("#rd-google-map-address-submit").on("click", function(
                        e
                      ) {
                        e.preventDefault();
    ...
    if (plugins.swiper.length) {
      for (var i = 0; i < plugins.swiper.length; i++) {
        ...
        var swiperOptions = {
          autoplay:
            s.attr("data-autoplay") && Number(s.attr("data-autoplay"))
              ? {
    ...
    if (plugins.themeSwitcher.length) {
      ...
      document.documentElement.addEventListener("theme-color-change", function(
        event
      ) {
